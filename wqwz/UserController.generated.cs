...
namespace wqwz.Controllers
{
    public partial class UserController
    {
        ...
        static readonly ActionParamsClass__Login s_params__Login = new ActionParamsClass__Login();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass__Login _LoginParams { get { return s_params__Login; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass__Login
        {
            public readonly string entity = "entity";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Login = "~/Views/User/_Login.cshtml";
            public readonly string Add = "~/Views/User/Add.cshtml";
            public readonly string Success = "~/Views/User/Success.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : wqwz.Controllers.UserController
    {
        public T4MVC_UserController() : base(Dummy.Instance) { }

        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.User entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(wqwz.Models.User entity)
        {
        ...
        [NonAction]
        partial void _LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult _Login()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames._Login);
            _LoginOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void _LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.User entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult _Login(wqwz.Models.User entity)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames._Login);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "entity", entity);
            _LoginOverride(callInfo, entity);
            return callInfo;
        }
        ...
        [NonAction]
        partial void RemoveOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.User entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Remove(wqwz.Models.User entity)
        {
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.User entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(wqwz.Models.User entity)
        {
