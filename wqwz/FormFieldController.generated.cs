...
namespace wqwz.Controllers
{
    public partial class FormFieldController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected FormFieldController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FormFieldController Actions { get { return MVC.FormField; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "FormField";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "FormField";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FormFieldController : wqwz.Controllers.FormFieldController
    {
        public T4MVC_FormFieldController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.FormField entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(wqwz.Models.FormField entity)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
        ...
        [NonAction]
        partial void RemoveOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.FormField entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Remove(wqwz.Models.FormField entity)
        {
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, wqwz.Models.FormField entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(wqwz.Models.FormField entity)
        {
